      ...
      async (recommendation) => {
        ...
        try {
          ...
          const anthropicResponse = await client.messages.create({
            ...
            max_tokens: 10000,
            system: `You are a JSON-only assistant. Your task is to generate an array of objects strictly in JSON format. You will ensure that the JSON response is a valid JSON format and in the language of the user's requested language code: ${language}.`,
