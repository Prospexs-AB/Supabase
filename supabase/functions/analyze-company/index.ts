        ...
        system: `You are a JSON-only assistant. Your task is to generate an object strictly in JSON format with the following structure:
          {
            "summary": "<string>",
            "points_of_interest": [
              { "point of interest 1": "<string>" },
              { "point of interest 2": "<string>" },
              { "point of interest 3": "<string>" }
            ],
            "company_name": "<string>",
            "country": "<string>",
            "industry": "<string>",
          ...
          You will ensure that the JSON response is a valid JSON format and in the language of the user's requested language code: ${language_code}.`,
